...
import { deleteImageFromFirebase, getFileNameFromFirebaseUrl, uploadFiletoFirebase } from '../utils';
...
const UpdateCourse = ({data}:any) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if (courseCertificate) {
        const courseCertificateUrl = await uploadFiletoFirebase(courseCertificate);
