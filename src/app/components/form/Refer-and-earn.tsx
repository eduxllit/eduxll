          ...
          <div className={`formbox flex flex-col gap-[10px] ${className}`}>
            ...
            <div className="max-w-sm space-y-3 m-auto w-full">
              ...
              >
                ...
                <option value="IIT-Kanpur">IIT Kanpur University</option>

                <option value="Amiti-University">Amity University</option>
                 <option value="UPES-University">UPES University</option>
                <option value="The-Jeff-Goldberg-Studio">The Jeff Goldberg Studio</option>
                <option value="manipal-University">Manipal University</option>
                <option value="NASSCOM">NASSCOM</option>
                <option value="MIA-Digital-University">MIA Digital University </option>
               </select>
            </div>
            <div className="max-w-sm space-y-3 m-auto w-full">
              <input
            ...
            <div>
                ...
                <label htmlFor="agree" className="text-xs font-[300] tracking-wider"> I authorise eduXLL and its associates to contact me with updates & notifications via Email, SMS, WhatsApp, and Voice call as per the Privacy Policy.</label>
            </div>
