      ...
      <HeaderLayout>
        <div>
          <div className="bg-[url('/65e8a443d3a217849e428432_dhruv-hero-image.png')] relative pt-10 pb-20 sm:px-24 px-2">
            <div className="max-w-[670px] max-sm:w-[100%] bg-white relative rounded-md p-6">
                ...
                <div className="flex gap-4 sm:mt-0 mt-2">
                  {response?.logoOne && (
                    <div className="flex gap-2 items-center">
                      <Image
                        ...
                        width={85}
                        height={40}
                        className="w-[85] h-[40px] object-contain"
                      />
                  ...
                  {response?.logoTwo && (
                    <div className="flex gap-2 items-center">
                      ...
                      />
                      <div className="banner-text">
                        {response?.logoTwodescription.length > 14 ? (
                          <div
                            dangerouslySetInnerHTML={{
                              __html:
          ...
          <section
            id="certificate"
            className=" py-[30px] certtingg border border-b-slate-50 bg-[#cccfd3] border-t-slate-50 mt-[30px]  "
          >
                            ...
                            <>
                              ...
                              <div className="rankcontentbox flex-1">
                                <div
                                  dangerouslySetInnerHTML={{
                                    __html:
                                      response?.logoOnedescription?.replace(
                                        /"/g,
                                        ""
                                      ),
                                  }}
