...
import CourseStaticAbroad from "../components/courseStaticCard";
  ...
  return (
    <HeaderLayout>
      ...
      <div className="px-4">
        ...
        <CourseStaticAbroad onlyCards={true} />
      </div>
          ...
          <div className="sm:flex grid gap-4 overflow-hidden">
            {abroadArray?.map((item, index) => {
              return (
                <div
                  key={index}
                  className="overflow-hidden rounded-xl w-[410px] h-[220px] cursor-pointer hover:shadow-xl relative "
                >
