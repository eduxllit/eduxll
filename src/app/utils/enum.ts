export const enumToValue = (value: any) => {
  switch (value) {
    ...
    case "MA in  Journalism and Mass Communication (MAJMC)":
      return "MAJMC";
    case "MBA in Digital Marketing":
      return "MBA in Digital Marketing";
    case "MA in Public Policy & Governance":
      return "MA in Public Policy & Governance";
   /*  case "MBA in Power Management":
      return "MBA in Power Management";
    case "MBA in Oil & Gas Management":
      return "MBA in Oil & Gas Management";
    case "MBA in Marketing Management":
      return "MBA in Marketing Management";
    case "MBA in Infrastructure Management":
      return "MBA in Infrastructure Management";
    case "MBA in Human Resource Management":
      return "MBA in Human Resource Management";
    case "MBA in Finance Management":
      return "MBA in Finance Management"; 

    case "Bachelor of Arts (BA)":
      return "Bachelor of Arts (BA)";*/
    case "Bachelor of Commerce (B.Com)":
  ...
  /*    case "IoT- Product Manager":
      return "IoT- Product Manager";
    case "Robotics Process Automation Consultant":
      return "Robotics Process Automation Consultant";
    ...
    case "ESG and Business Sustainability":
      return "ESG and Business Sustainability";
    default:
      return "";
  }
};
